...
export const useExpenseCategoryStore = defineStore(
    ...
    () => {
        ...
        const getQuickBooksList = () => {
            return globalStore.actionWrapper(async () => {
                const res = await ExpenseCategoryService.getQuickBooksList();
                return res.data;
            });
        };
        ...
        const changeStatus = (id, payload) => {
            return globalStore.actionWrapper(async () => {
                ...
                globalStore.showSuccess(
                    'Expense Account status updated',
                    'Expense Account status updated successfully'
                );
                return res.data;
            });
        };
        ...
        const deleteItem = async (id) => {
            return globalStore.actionWrapper(async () => {
                ...
                globalStore.showSuccess(
                    'Expense Account deleted',
                    'Expense Account deleted successfully'
                );
                return res.data;
            });
        };
